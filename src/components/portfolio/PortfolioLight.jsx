		...
		<ul className="row grid">
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalOne}>
					...
					<div className=" direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">E-Commerce Project</span>
					</div>
				</figure>

				{/* <!-- Portfolio Item Starts --> */}
				<Modal isOpen={isOpen} onRequestClose={toggleModalOne} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalTwo}>
					...
					<div className=" direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">College Social Project</span>
					</div>
				</figure>

				{/* Start ModalTwoContent */}
				<Modal isOpen={isOpen2} onRequestClose={toggleModalTwo} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalThree}>
					...
					<div className=" direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">Restaurant Project</span>
					</div>
				</figure>

				{/* Start ModalThreeContent */}
				<Modal isOpen={isOpen3} onRequestClose={toggleModalThree} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalFour}>
					...
					<div className="direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">Social Network Project</span>
					</div>
				</figure>

				{/* Start ModalFourContent */}
				<Modal isOpen={isOpen4} onRequestClose={toggleModalFour} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalFive}>
					...
					<div className="direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title"> Travel-App Project </span>
					</div>
				</figure>

				{/* Start ModalFiveContent */}
				<Modal isOpen={isOpen5} onRequestClose={toggleModalFive} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalSix}>
					...
					<div className=" direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">Headphones Page Project</span>
					</div>
				</figure>

				{/* Start ModalSixContent */}
				<Modal isOpen={isOpen6} onRequestClose={toggleModalSix} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalSeven}>
					...
					<div className=" direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">Melt Website</span>
					</div>
				</figure>

				{/* Start ModalSevenContent */}
				<Modal isOpen={isOpen7} onRequestClose={toggleModalSeven} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalEight}>
					...
					<div className="direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">Real Estate Project</span>
					</div>
					{/* Start ModalEightContent */}
					<Modal isOpen={isOpen8} onRequestClose={toggleModalEight} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
						<div>
			...
			<li className="direction-reveal">
				<figure className="direction-reveal__card" onClick={toggleModalNine}>
					...
					<div className="direction-reveal__overlay direction-reveal__anim--enter">
						<span className="direction-reveal__title">Estate Project</span>
					</div>
				</figure>

				{/* Start ModalNineContent */}
				<Modal isOpen={isOpen9} onRequestClose={toggleModalNine} contentLabel="My dialog" className="custom-modal dark green" overlayClassName="custom-overlay" closeTimeoutMS={500}>
					<div>
