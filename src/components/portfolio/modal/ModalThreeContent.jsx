        ...
        <figcaption>
          ...
          <div className="row open-sans-font">
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">Restaurant Web App</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://github.com/ninganzaremy/Restaurant-application/"
                  target="_blank"
                  rel="noreferrer"
                >
                  Code
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://bola-restaurant.herokuapp.com/"
                  target="_blank"
                  rel="noreferrer"
                >
                  Site
