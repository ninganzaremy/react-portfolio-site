				...
				<figcaption>
					...
					<div className="row open-sans-font">
						<div className="col-12 col-sm-6 mb-2">
							...
							<span className="project-label"> </span>: <span className="ft-wt-600 uppercase">Travel Web App</span>
						</div>
						{/* End .col */}
						...
						<div className="col-12 col-sm-6 mb-2">
							...
							<span className="project-label"> </span>: <span className="ft-wt-600 uppercase">React.js, Node.js, Javascript</span>
						</div>
						{/* End .col */}
