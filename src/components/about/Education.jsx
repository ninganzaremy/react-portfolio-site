...
const educationContent = [
  ...
  },
  {
    ...
    details: ["BCS in Computer Science: Completed a four-year Bachelor of Science in Computer Science at LIGHT UNIVERSITY OF BUJUMBURA.",
      ...
      <ul>
        {educationContent.map((val, i) => (
            <li key={i}>
              ...
              <span
                  className="time open-sans-font text-uppercase">{val.year}</span>
