...
const heroContent = {
	...
	heroDescriptions: `I'm a WEB DEVELOPER / AWS CERTIFIED DEVELOPER focused on
  crafting clean & user‑friendly experiences, I am passionate about
  building excellent software that improves the lives of those
  around me. Proficient at working with cutting-edge technology in a fast-paced environment with an innate ability to learn new tools.
`,
...
const HeroLight = () => {
	...
	return (
		<>
			...
			<Modal isOpen={isOpen} onRequestClose={toggleModalOne} contentLabel="My dialog" className="custom-modal dark light" overlayClassName="custom-overlay" closeTimeoutMS={500}>
				<div>
